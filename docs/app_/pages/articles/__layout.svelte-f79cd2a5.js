import{S as D,i as O,s as P,F as V,e as o,t as $,k as A,L as Y,c as l,a as d,d as e,h as K,m as R,b as s,M as Q,J as a,g as M,G as X,H as Z,I as ee,q as te,o as ae}from"../../chunks/vendor-ba5e527f.js";import{a as ne,b as se}from"../../chunks/paths-396f020f.js";function re(g){let i,p,f,h,c,x,_,N,y,j,I,m,E,v,u,L,C,S,z,k,w;const F=g[2].default,r=V(F,g,g[1],null);return{c(){i=o("link"),p=o("link"),f=o("link"),h=o("link"),c=o("script"),_=o("script"),N=$(`window.dataLayer = window.dataLayer || [];
    ...
    `),y=o("style"),j=$(`body {
        ...
        }`),I=A(),m=o("main"),E=o("nav"),v=o("h2"),u=o("a"),L=$("Svelte SaaS Starter Kit"),C=A(),S=o("article"),r&&r.c(),z=A(),k=o("footer"),this.h()},l(t){const n=Y('[data-svelte="svelte-vuylx4"]',document.head);i=l(n,"LINK",{rel:!0,href:!0}),p=l(n,"LINK",{rel:!0,href:!0}),f=l(n,"LINK",{rel:!0,href:!0,crossorigin:!0}),h=l(n,"LINK",{href:!0,rel:!0}),c=l(n,"SCRIPT",{src:!0});var W=d(c);W.forEach(e),_=l(n,"SCRIPT",{});var U=d(_);N=K(U,`window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());

            gtag('config', 'G-FSJW8FC22N');
    `),U.forEach(e),y=l(n,"STYLE",{});var T=d(y);j=K(T,`body {
            font-family: "Inter",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,"Noto Sans",sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji";
        }
        h1 {
            font-size: 3rem;
